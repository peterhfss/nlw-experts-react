...
export function NewNoteCard(){
  ...
  return(
      <Dialog.Root>
        <Dialog.Trigger className='rounded-md bg-slate-700 flex flex-col p-5 gap-3 text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
